...
- [ ] `src/services/theme.test.js` — stubs for DARK-01, DARK-02, DARK-04 (ThemeService unit tests)
- [ ] `src/test-setup.js` — add `window.matchMedia` mock (happy-dom does not implement it)

export function mount(el, params) {
  el.innerHTML = `
    <div class="p-4 space-y-8 pb-32">
      ...
      <section class="space-y-4">
        <h2 class="text-lg font-bold text-blue-600 flex items-center">
          <span class="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs mr-2">4</span>
      ...
      <footer class="text-center pt-4">
        <p class="text-xs text-gray-400">Pickleball Practice Scheduler v1.0</p>
      </footer>
    </div>
  `;
}
